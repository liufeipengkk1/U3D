...
//	glStencilFunc(GL_NOTEQUAL, 1, GL_REPLACE);
//	glStencilOp(GL_KEEP,GL_KEEP,GL_REPLACE);
//
//	Shader shader("Shader/simpleTexture.vs","Shader/simpleTexture.frag");
//	Shader shaderSingleColor("Shader/singlecolor.vs","Shader/singlecolor.frag");
...
//	glBindVertexArray(0);
//
//	GLuint cubeTexture = loadTexture("Pic/container.jpg");
//	GLuint floorTexture = loadTexture("Pic/wall.jpg");
//
