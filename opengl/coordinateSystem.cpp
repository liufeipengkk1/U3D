...
void coordinateSys_callback(GLFWwindow * window,int key,int scancode,int action,int mode);
...
void main_coor()
{
	...
	glfwSetKeyCallback(window,coordinateSys_callback);

	glewExperimental = GL_TRUE;
	glewInit();
    glViewport(0, 0, WIDTH, HEIGHT);
	LCShader shader("Shader/coorSysBasic.vs","Shader/coorSysBasic.frag");
    ...
    int width, height;
    unsigned char* image = SOIL_load_image("Pic/woman.jpg", &width, &height, 0, SOIL_LOAD_RGBA);
    ...
    unsigned char * image1 = SOIL_load_image("Pic/another woman.jpg", &width, &height, 0, SOIL_LOAD_RGBA);
	...
	while(!glfwWindowShouldClose(window))
	{
		...
		//model = rotate(model,  (GLfloat)glfwGetTime() / 10.0f, vec3(1.0f, 0.0f, 0.0f));
