...
//using cosine to represant the angles,and we leave the ambient light when the 
//fragment is outside the outer cone
struct Light{
    vec3 position;
    vec3 direction;
    float cutOff;
...
void main()
{
    ...
    //spot light with soft edges and we leave the ambient color
