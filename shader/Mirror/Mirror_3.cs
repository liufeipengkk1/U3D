...
public class Mirror_3 : MonoBehaviour
{
    ...
    void OnWillRenderObject()
    {
		...
		Transform oldParent = Camera.main.transform.parent;
		...
		//float d = Vector3.Dot(transform.up, Camera.main.transform.position-transform.position)-0.01f;
		float d = Vector3.Dot(transform.up, Camera.main.transform.position-transform.position);
